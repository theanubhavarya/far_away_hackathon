...
BOOKING_PROVIDERS = {
    "cab": ("Uber", "https://m.uber.com"),
    "flight": ("IRCTC Air", "https://www.air.irctc.co.in"),
    "train": ("IRCTC", "https://www.irctc.co.in"),
    "bus": ("RedBus", "https://www.redbus.in"),
    "metro": ("Delhi Metro", "https://delhimetrorail.com"),
    "auto": ("Ola Auto", "https://book.olacabs.com"),
    "walk": ("Google Maps", "https://maps.google.com")
}
...
def build_route_option(scored: dict, travel_date: str, index: int, accessible: bool, bags: int) -> RouteOption:
    ...
    for segment_index, leg in enumerate(scored["route"]):
        ...
        provider_name, booking_url = BOOKING_PROVIDERS.get(mode, ("Travel Provider", "https://example.com"))
