          ...
          <div style={{ fontSize: '0.8rem', color: 'var(--text-primary)', fontWeight: 600 }}>
            {(() => {
              ...
              if (parts.length === 2) {
                return (
                  <>
                    <FormatBrandText text={parts[0].replace('{user}', msg.user)} />
                    <span style={{ color: 'var(--color-success)' }}>{msg.saved}</span>
                    <FormatBrandText text={parts[1].replace('{user}', msg.user)} />
                  </>
                );
              }
              return <FormatBrandText text={template} />;
            })()}
          </div>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: 32, marginBottom: 40 }}>
          ...
          <div>
            ...
            <p style={{ margin: 0, color: '#d1d5db', marginBottom: 16 }}>Built for Far Away 2026 International Hackathon</p>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: 16 }}>
            ...
            <a href="mailto:user@support.yatri.ai" style={{ display: 'flex', alignItems: 'center', gap: 8, color: '#a0a0a0', textDecoration: 'none', transition: 'color 0.2s' }} onMouseEnter={e => e.currentTarget.style.color = '#fff'} onMouseLeave={e => e.currentTarget.style.color = '#a0a0a0'}>
              <Mail size={16} /> user@support.yatri.ai
            </a>
          </div>
        </div>
        ...
        <div style={{ borderTop: '1px solid #222', paddingTop: 24, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 16, color: '#d1d5db' }}>
          <p style={{ margin: 0 }}>© 2026 Yatri AI Pvt. Ltd. All rights reserved.</p>
          <p style={{ margin: 0 }}>
  ...
  return (
    <main>
      ...
      <section style={{
        ...
        <motion.div
          className="hide-on-mobile social-proof-card"
          ...
          >
            ...
            <motion.div
              ...
              style={{
                ...
                width: '56%',
                aspectRatio: '4/3',
                backgroundImage: 'url(/frontend-images/3.jpg)',
            ...
            <motion.div
              ...
              style={{
                ...
                width: '56%',
                aspectRatio: '4/3',
                backgroundImage: 'url(/frontend-images/1.jpg)',
                backgroundSize: 'cover',
                backgroundPosition: 'center',
                borderRadius: '16px',
                border: '6px solid rgba(255,255,255,0.4)',
