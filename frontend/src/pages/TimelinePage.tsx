...
import { Bell, ChevronDown, ChevronUp, Clock, DollarSign, Leaf, Share2, Shield, Star } from 'lucide-react';
...
export default function TimelinePage() {
  ...
  return (
    <div style={{ minHeight: 'calc(100vh - 64px)', padding: '24px', maxWidth: 720, margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', marginBottom: 32 }}>
        ...
        <KpiCard icon={DollarSign} label="Total Cost" value={formatCurrency(totalCost)} color="var(--color-accent)" />
        <KpiCard icon={DollarSign} label="Per Person" value={formatCurrency(costPerPerson)} color="var(--color-accent)" />
